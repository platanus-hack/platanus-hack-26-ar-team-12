...
- Run `docs/03-DEMO-CHECK.md` on the demo device, especially contact/channel clarification loops and actual `CALL_PHONE` permission behavior from service context.
