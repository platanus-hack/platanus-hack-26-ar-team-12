...
The keys live in `.claude/settings.json` (project) or `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.gemini/settings.json` (global) — **not** in `.planning/config.json`:
