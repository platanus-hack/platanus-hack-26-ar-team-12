...
```
Agent(
  prompt="Read /Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.gemini/get-shit-done/templates/VALIDATION.md`
