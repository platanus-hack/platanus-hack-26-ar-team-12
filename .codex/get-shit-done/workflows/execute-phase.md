...
@/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/references/context-budget.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/references/planner-antipatterns.md
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/workflows/execute-plan.md` **inline**
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/references/checkpoints.md
       @/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/references/tdd.md
       @/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/references/executor-examples.md'}
       </execution_context>
...
5.5. **Worktree cleanup (when `isolation="worktree"` was used):**
   ...
   **Cleanup-tail snippet (use after any wave whose merges did not flow through the templated path above):**
   ...
   # Inclusion-based filter (#2774): match ONLY agent-spawned worktrees under
   # `.codex/worktrees/agent-`. Do NOT use exclusion filters (grep -v "$(pwd)$") —
...
Read and follow `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
