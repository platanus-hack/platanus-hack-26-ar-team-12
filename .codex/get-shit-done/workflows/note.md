...
- **Global scope**: `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/notes/`)
...
2. Glob `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/notes/` — works in any directory
