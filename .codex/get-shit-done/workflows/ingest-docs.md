...
```bash
INIT=$(node "/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
