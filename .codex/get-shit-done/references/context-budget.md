...
The keys live in `.codex/settings.json` (project) or `/Users/msancheznovelli/Developer/platanus/platanus-hack-26-ar-team-12/.codex/settings.json` (global) — **not** in `.planning/config.json`:
